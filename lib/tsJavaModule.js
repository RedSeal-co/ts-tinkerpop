...
(function (Java) {
    ...
    function newShort(val) {
        return _java.newShort(val);
    }
    Java.newShort = newShort;
    function newLong(val) {
        return _java.newLong(val);
    }
    Java.newLong = newLong;
    function newFloat(val) {
        return _java.newFloat(val);
    }
    Java.newFloat = newFloat;
    function newDouble(val) {
        return _java.newDouble(val);
    }
