...
declare module 'ts-tinkerpop' {
    ...
    import _java = require('__ts-tinkerpop/index/__/redseal-java');
...
declare module '__ts-tinkerpop/java' {
    // java.d.ts
    // This file was generated by ts-java.
    
    
    declare module '__ts-tinkerpop/index/__/redseal-java' {
        var Java: Java.NodeAPI;
        export = Java;
    }
    
    declare module '__ts-tinkerpop/index/__/java' {
        var Java: Java.NodeAPI;
        export = Java;
    }
